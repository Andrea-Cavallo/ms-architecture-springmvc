package com.application.CloudGateway.controller;
...
import com.application.CloudGateway.model.AuthenticationResponse;
...
public class AuthenticationController {
	...
	public ResponseEntity<AuthenticationResponse> login(@AuthenticationPrincipal OidcUser oidcUser, Model model,
		...
		AuthenticationResponse authenticationResponse = AuthenticationResponse.builder().userId(oidcUser.getEmail())
				...
				.expiresAt(client.getAccessToken().getExpiresAt().getEpochSecond()).authorityList(oidcUser
